...
## How to use
**Repository layout**
Remember to create both folders named here, db (put init_db.py inside of it) and data (put the csv file "operational_intelligence_transactions_db.csv" inside of this one).
